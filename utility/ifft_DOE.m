function [out]=ifft_DOE(in,factor,noc,nor)
%function [out]=ifft_DOE(in,factor,noc,nor)
%this fuction is used for ifft calculation of DOE with finite aperture
...
%     noc,noc ---- the size of the output ifft image
%outpu:
%     out     ---- outpu image
...
% check input
if noc > round(nc*factor) || round(nor > nr*factor)
